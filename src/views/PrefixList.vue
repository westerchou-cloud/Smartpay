            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- IP Whitelist -->
                        <div class="space-y-1.5">
                            <label class="block text-sm font-medium text-slate-700">IP Whitelist <span class="text-xs text-slate-400 font-normal ml-1">(One IP per line)</span></label>
                            <textarea v-model="form.ipWhitelist" rows="3" placeholder="103.21.xx.xx&#10;192.168.1.1" 
                                class="w-full bg-white border border-slate-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all font-mono placeholder:text-slate-300"></textarea>
                        </div>
                    </div>
...
import { 
    ...
    Copy, RefreshCw, Settings, Link, Save, CheckCircle 
